        ...
        if (registries != null && !registries.isEmpty()) {
            for (RegistryConfig config : registries) {
                ...
                if (address.length() > 0 && !RegistryConfig.NO_AVAILABLE.equalsIgnoreCase(address)) {
                    ...
                    for (URL url : urls) {
                        //设置url中的registry为对应的注册中心，如zookeeper
                        url = url.addParameter(Constants.REGISTRY_KEY, url.getProtocol());
                        //将protocol设置为registry，为了之后适配所有的注册中心类型
                        //即原来的注册中心地址由zookeeper://192.168.231.10:2181/com.alibaba.dubbo.registry.RegistryService?application=dubbo-server&dubbo=2.5.3&owner=zmk&pid=53448&timestamp=1532841626575
                        //registry://192.168.231.10:2181/com.alibaba.dubbo.registry.RegistryService?application=dubbo-server&dubbo=2.5.3&owner=zmk&pid=53448&timestamp=1532841626575
